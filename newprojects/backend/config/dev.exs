...
config :immo, ImmoWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "n+DUOlmF3Jlv5R5MT7032XmnYRx8Hbqejtg5lEPX2jq1qXn9Z/r0o6v8Eh+xAc1v",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:immo, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:immo, ~w(--watch)]}
  ]
...
config :immo, ImmoWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/immo_web/router\.ex$"E,
      ~r"lib/immo_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :immo, dev_routes: true
